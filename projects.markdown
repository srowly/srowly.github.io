...
<!--
This section adds custom styles for our project grid.
You can move this to your main CSS file later if you want.
-->
...
It loops through all the project files in your new _projects folder.
-->
...
<!--
This links to the project's own page, using the
data from the project's file (e.g., _projects/comet.md)
-->
